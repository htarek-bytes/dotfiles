...
# Mouse Toggle for MacBook Pro 2017 (Hyprland)
alias moff='hyprctl keyword "device[apple-spi-touchpad]:enabled" false > /dev/null 2>&1'
alias mon='hyprctl keyword "device[apple-spi-touchpad]:enabled" true > /dev/null 2>&1'
